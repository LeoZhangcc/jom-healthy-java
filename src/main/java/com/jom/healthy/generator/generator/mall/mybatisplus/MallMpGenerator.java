package com.jom.healthy.generator.generator.mall.mybatisplus;
...
import com.jom.healthy.generator.generator.base.AbstractMpGenerator;
 ...
 */
public class MallMpGenerator extends AbstractMpGenerator {

    private MpParam mpContextParam;

    public MallMpGenerator(MpParam mpContextParam) {
    ...
    protected void beforeGeneration() {
        ...
        contexMap.put("EntitySpecParams", this.contextParam.getProPackage().replace("src.main.java.","") + ".model.params");
        contexMap.put("EntitySpecResult", this.contextParam.getProPackage().replace("src.main.java.","") + ".model.result");

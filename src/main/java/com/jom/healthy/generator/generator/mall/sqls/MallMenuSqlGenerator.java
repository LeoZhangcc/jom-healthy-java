package com.jom.healthy.generator.generator.mall.sqls;

import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.core.toolkit.IdWorker;
import com.baomidou.mybatisplus.generator.config.po.TableInfo;
import com.jom.healthy.generator.generator.base.AbstractCustomGenerator;
import com.jom.healthy.generator.util.TemplateUtil;
 ...
 */
public class MallMenuSqlGenerator extends AbstractCustomGenerator {

    public MallMenuSqlGenerator(Map<String, Object> tableContext) {
        super(tableContext);
    }
    ...
    public String getTemplateResourcePath() {
        return "/mallTemplates/menu_sql.sql.btl";
    }
